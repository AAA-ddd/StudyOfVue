<template>
  <div>
    ...
    <!--      修改地址对话框-->
    <el-dialog title="修改地址" :visible.sync="addressVisiable" width="50%" @close="addressDialogClose">
      <el-form :model="addressForm" :rules="addressRules" ref="addressRefs" label-width="100px">
...
<!--    物流进度-->
    <el-dialog title="物流进度" :visible.sync="progressVisiable" width="50%">
      <el-timeline>
        <el-timeline-item
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // 页数改变触发函数
      handleSizeChange (newVals) {
        this.queryInfo.pagesize = newVals
        this.getOrderList()
      },
      // 当前页面的值
      handleCurrentChange (newVals) {
        this.queryInfo.pagenum = newVals
        this.getOrderList()
      },
      showBox() {
